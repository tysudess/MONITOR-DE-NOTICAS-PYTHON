...
class TermsPage(BasePage):
    """Termos de notícias e de vídeos ligados às persistências reais."""
    def __init__(self,controller):
        ...
        row.addWidget(self._term_card("Termos de Vídeos","Lista independente para vídeos",self.video_list,controller.add_video_term,controller.remove_video_term))
