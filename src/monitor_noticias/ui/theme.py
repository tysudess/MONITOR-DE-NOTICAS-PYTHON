...
QWidget#mainContent {{
    background: qlineargradient(x1:0,y1:0,x2:1,y2:1,stop:0 #03182b,stop:0.55 #032640,stop:1 #021426);
}}
QFrame#sidebar {{
...
QFrame#card, QFrame#techCard, QFrame#resultCard, QFrame#filterCard, QFrame#settingsBlock {{
    background:qlineargradient(x1:0,y1:0,x2:1,y2:1,stop:0 #06375b,stop:0.52 #052d4b,stop:1 #031f38);
    border:1px solid #0a82b4; border-radius:12px;
}}
...
QLineEdit, QComboBox, QSpinBox, QDateEdit, QTimeEdit {{
    background:#052a46; color:#eef8ff; border:1px solid #0a8cc1; border-radius:9px;
    padding:8px 10px; min-height:26px; selection-background-color:#087af7;
}}
QLineEdit::placeholder {{ color:#8faec7; }}
QLineEdit:focus, QComboBox:focus, QSpinBox:focus, QDateEdit:focus, QTimeEdit:focus {{ border:1px solid #00c3ff; }}
QComboBox::drop-down {{ border:0; width:22px; }}

QPushButton {{
    background:qlineargradient(x1:0,y1:0,x2:1,y2:1,stop:0 #087af7,stop:1 #095ad2);
    color:white; border:1px solid #18b9f3; border-radius:9px; padding:8px 14px;
...
QListWidget, QTableWidget {{
    background:transparent; color:#eaf6ff; border:0; gridline-color:#0c557b;
    alternate-background-color:#05243d; outline:0;
}}
